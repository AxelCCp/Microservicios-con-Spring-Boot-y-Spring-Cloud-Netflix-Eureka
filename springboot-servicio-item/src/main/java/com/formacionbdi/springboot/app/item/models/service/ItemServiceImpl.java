...
public class ItemServiceImpl implements IItemService {
	...
	//A TRAVÉS DEL CLIENTE REST OBTENEMOS EL OBJ QUE QUEREMOS DEL OTRO MICROSERVICIO:
	//getForObject("URL", "TIPO DEL OBJ QUE QUEREMOS OBTENER. UNA LISTA DE PRODUCTOS. EN ESTE CASO UN ARRAY");
	...
	//MAP(EXPRESIÓN LAMBDA... P: DE PRODUCTO  / -> : FLECHA / NEW ITEM(LE PASAMOS LA 'P' DE PRODUCTO , 1 : DE CANTIDAD ) ).
